...
CSVMONTH = r'C:\Program Files (x86)\PaperCut Print Logger\logs\csv\monthly\papercut-print-log-2024-12.csv'
...
def main():    
    ...
    while True:
        if os.path.exists(CSVMONTH):
            try:
                f = pd.read_csv(CSVMONTH, skiprows=2, encoding='ISO-8859-1')
